...
<html lang="en" class="app">
    ...
    <body>
        ...
        <input type="hidden" id="current_url" value="<?=current_url();?>/jsonEvents/">
        ...
        <input type="hidden" id="url_upload" value="<?php echo base_url();?>upload/evento/">
                                              ...
                                              <div class="col-sm-8 m-t-xs m-b-xs">
                                                <!--<div class="select filter" data-resize="auto">
                                                  <button data-toggle="dropdown" class="btn btn-sm btn-default dropdown-toggle">
                                                    <span class="dropdown-label" style="width: 107px;">Population &gt;= 5M</span>
                                                    <span class="caret"></span>
                                                  </button>
                                                  <ul class="dropdown-menu">
                                                    <li data-value="all"><a href="#">All</a></li>
                                                    <li data-value="lt5m"><a href="#">Like &lt; 1000</a></li>
                                                    <li data-value="gte5m"><a href="#">Like &gt;= 1000</a></li>
                                                  </ul>
                                                </div>-->
                                                <a href="events/new_events" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Nuevo evento</a>
                                              </div>
        ...
        ?>
        <script src="<?=base_url().$admin_css_js;?>js/datagrid/events.js"></script>
