...
<html lang="en" class="app">
    ...
    <body>
        ...
        <input type="hidden" id="current_url" value="<?=current_url();?>/jsonCountry/">
                                          ...
                                          <th>
                                            <div class="row">
                                              <div class="col-sm-8 m-t-xs m-b-xs">
                                                <a href="locations/new_locations" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Nuevo País</a>
                                              </div>
        ...
        ?>
        <script src="<?=$admin_css_js;?>js/datagrid/country.js"></script>
