...
<html lang="en" class="app">
    ...
    <body>
        ...
        <input type="hidden" id="current_url" value="<?php echo site_url('locations');?>/jsonCity/">
        <input type="hidden" id="url_active" value="<?php echo site_url('locations');?>/active_city/">
        <input type="hidden" id="url_desactive" value="<?php echo site_url('locations');?>/desactive_city/">
        <input type="hidden" id="url_edit" value="<?php echo site_url('locations');?>/edit_city/">
        <input type="hidden" id="url_delete" value="<?php echo site_url('locations');?>/delete_city/">
                                          ...
                                          <th>
                                            <div class="row">
                                              <div class="col-sm-8 m-t-xs m-b-xs">
                                                <a href="<?php echo site_url('locations/new_citys');?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Nuevo Ciudad</a>
                                              </div>
        ...
        ?>
        <script src="<?php echo base_url().$admin_css_js;?>js/datagrid/citys.js"></script>
