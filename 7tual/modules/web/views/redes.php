            ...
            <div class="tab-content">
                ...
                <div class="" id="ideas-eventos">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <h3 class="pull-left">Redes Sociales</h3>
                            <div class="btn-group btn-input clearfix select-2 pull-left">
                                <button type="button" class="btn btn-default dropdown-toggle form-control" data-toggle="dropdown">
                                    <span data-bind="label">Categoría</span>&nbsp;<span class="caret"></span>
                                </button>
                                <ul class="dropdown-menu" role="menu">
                                    <span>Todos</span>
                                    <li><a href="#">Ciudad0</a></li>
                                    <li><a href="#">Ciudad1</a></li>
                                    <li><a href="#">Ciudad2</a></li>
                                    <li><a href="#">Ciudad3</a></li>
                                    <li><a href="#">Ciudad4</a></li>
                                    <li><a href="#">Ciudad5</a></li>
                                    <li><a href="#">Ciudad6</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <button type="button" class="btn btn-1 btn-1-1"><span><img src="http://localhost/7tualsys/assets/images/icon-plus.png"></span>AÑADIR CONTENIDO</button>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 wrapper-redes">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="row item-redes">
                                        <figure>
                                            <a href="#">
                                                <figcaption>Título medio. Nombre artículo o video.</figcaption>
                                                <img src="<?=$web_upload;?>redes-01.jpg" class="img-responsive">
                                                <div class="btn_play">
                                                    <img src="<?=$web_img;?>images/play-video.png">
                                                </div>
                                            </a>
                                        </figure>
                                    </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="row item-redes">
                                        <figure>
                                            <a href="#" title="">
                                                <figcaption>Título medio. Nombre artículo o video como máximo dos líneas de título.</figcaption>
                                                <img src="<?=$web_upload;?>redes-01.jpg" class="img-responsive">
                                            </a>
                                        </figure>
                                    </div>
