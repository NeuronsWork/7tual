            ...
            <div class="grupo total">
                <div class="caja tablet-50">
                    <div class="container">
                        ...
                        <p>Únete para llegar al tuyo. Necesitamos reunir a una gran cantidad de público que nos facilite convencer a patrocinadores locales para llegar muy cerca de ti.</p><img src="<?=base_url().$web_img;?>img/publico-img1.jpg">
                    </div>
                </div>
                <div class="caja tablet-50">
                    <div class="container">
                        ...
                        <div class="colaboradores">
                            <div class="colaborador"><img src="<?=base_url().$web_img;?>img/publico-img1.jpg" class="colaborador__img">
                                <p class="colaborador__descripcion">Perú - Lima</p>
                            </div>
                            <div class="colaborador"><img src="<?=base_url().$web_img;?>img/publico-img1.jpg" class="colaborador__img">
                                <p class="colaborador__descripcion">Perú - Lima</p>
                            </div>
