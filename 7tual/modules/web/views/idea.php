            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="row" id="ideas-eventos">
                    <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-8 col-md-offset-2 col-xs-12">
                        <h3 class="marginH3"><img src="<?=$web_img;?>images/icon-chat-1.png"> Ideas de Eventos</h3>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="row" id="ideas-events">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 idea">
                                    <div class="head">
                                        Categoría <strong>·</strong> Perú <strong>·</strong> Lima <strong>·</strong> 09/04/2014 <strong>·</strong> 22:35
                                    </div>
                                    <div class="body">
                                        <div class="col-lg-9">
                                    ...
                                    <div class="foot">
                                        <div class="col-lg-9">
                                            <div class="row">
                                                <div class="col-lg-6">Nombre del autor</div>
                                                <div class="col-lg-6 text-right">
                                                    <button type="button" class="btn btn-2 dropdown-toggle" data-toggle="dropdown">Comentar <span class="caret"></span></button>
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 share">
                                            <div class="row">
                                                <a href="#" class="fb"><span class="icon-facebook-circled"></span></a>
                                                <a href="#" class="yt"><span class="icon-youtube-alt"></span></a>
                                                <a href="#" class="c"><span>C</span></a>
                                                <a href="#" class="st"><span class="icon-star-24"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
