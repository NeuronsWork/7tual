            ...
            <div class="grupo container">
                <div class="caja">
                    ...
                    <div class="equipo-miembros">
                        <div class="miembro">
                            <div class="miembro__cargo">Gerente General</div>
                            <div class="miembro__nombre">Javier Lazo O.</div>
                        </div>
                        <div class="miembro">
                            <div class="miembro__cargo">Gerente de Desarrollo</div>
                            <div class="miembro__nombre">Jose D.</div>
                        </div>
                        <div class="miembro">
                            <div class="miembro__cargo">Publicidad</div>
                            <div class="miembro__nombre">Juan F</div>
                        </div>
                        <div class="miembro">
                            <div class="miembro__cargo">Diseño gráfico</div>
                            <div class="miembro__nombre">Manuel Z</div>
                        </div>
                        <div class="miembro">
                            <div class="miembro__cargo">Diseño web</div>
                            <div class="miembro__nombre">José B.</div>
                        </div>
                        <div class="miembro">
                            <div class="miembro__cargo">Programación web</div>
                            <div class="miembro__nombre">Jareth M</div>
                        </div>
                    </div>
                </div>
            </div>
