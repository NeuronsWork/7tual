...
<html lang="en" class="app">
    ...
    <body>
        ...
        <input type="hidden" id="current_url" value="<?php echo site_url('managers');?>/jsonManagers/">
                                          ...
                                          <th>
                                            <div class="row">
                                              <div class="col-sm-8 m-t-xs m-b-xs">
                                                <a href="<?php echo site_url('managers/new_manager');?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> Nuevo Manager</a>
                                              </div>
        ...
        ?>
        <script src="<?php echo base_url().$admin_css_js;?>js/datagrid/managers.js"></script>
