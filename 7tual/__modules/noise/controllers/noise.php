...
class Noise extends MX_Controller
{
    ...
    ## functions de prueba
    public function list_noise(){
        $data = $this->noise_model->list_noise($this->session->userdata('code_country'));
        //print_r($data);
    }

    public function list_noise_vip(){
        $data = $this->noise_model->list_noise_vip($this->session->userdata('code_country'));
        //print_r($data);
    }
