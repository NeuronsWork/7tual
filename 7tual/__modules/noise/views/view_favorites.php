                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 noise">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 title">
                                        ...
                                        <ul class="nav nav-pills pull-right" role="tablist">
                                            ...
                                            <li>
                                                ...
                                                <a href="#me-apunto" data-toggle="modal" data-target="#myFormRegisternoise" class="btn"><span class="icon icon-plus-3"></span>Añadir</a>
                                                <?php else: ?>
                                    ...
                                    $i=0;
                                    //print_r($list_noise);
                                    foreach ($list_noise_favorites as $item) {
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 slide-row slide-row-no-img">
                                                ...
                                                <div class="slide-footer">
                                                    <span class="pull-right buttons">
                                                        ...
                                                        <button data-id="<?php echo $item->id_notion;?>" class="btn remove_apunto" id="btn_<?php echo $item->id_notion;?>"><span class="icon icon icon-elusive-icons-30"></span>Apuntado</button>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
