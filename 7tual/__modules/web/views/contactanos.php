            ...
            <div class="row contactanos">
                ...
                <div class="col-md-8 col-md-offset-2 text-center">
                    <div class="col-lg-12 bg-contactanos">
                        ...
                        <form class="form-horizontal" method="post" action="<?=site_url('web/add_message');?>" id="form_add_message">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    <select name="selectAsunto" class="form-control" required>
                                        <option value="Empresa">Asunto</option>
                ...
                <!--<div class="col-lg-4">
                    <h2 class="text-right">Encuéntranos</h2>
                    <p class="text-right">
                        Calle Juan Figari 146 - Oficina 3D<br>
                        Miraflores - Lima
                        <span><img src="<?=$web_img;?>images/icon-direccion.png"></span>
                    </p>
                    <p class="text-right">(
                        511) 748 4002 - (511) 2414420
                        <span><img src="<?=$web_img;?>images/icon-telefonos.png"></span>
                    </p>
                    <p class="text-right">
                        contacto@7tual.com
                        <span><img src="<?=$web_img;?>images/icon-email.png"></span>
                    </p>
                </div>-->
