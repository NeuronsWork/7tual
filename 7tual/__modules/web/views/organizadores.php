                ...
                <div class="" id="ideas-eventos">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
                            <h5 class="pull-left">Organizadores</h5>
                            <button type="button" class="btn btn-1 btn-1-1 pull-right"><span><img src="http://localhost/7tualsys/assets/images/icon-plus.png"></span>¿Eres una empresa?</button>
                        </div>
                        <div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 organizadores">
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 organizador">
                                    <figure>
                                        <img src="<?=$web_upload;?>organizador.png" alt="" class="img-responsive">
                                        <figcaption>Nombre empresa</figcaption>
                                    </figure>
                                </div>
                                <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12 organizador">
                                    <figure>
