            ...
            <div class="tab-content">
                ...
                <div class="" id="ideas-eventos">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12 filosofia">
                            <h5>Preguntas frecuentes</h5>
                            <div class="texto">
                                <h6>¿Lorem ipsum dolor sit amet?</h6>
                                <p>Consectetur adipiscing elit. Etiam aliquam orci sem, sed dignissim sem feugiat sed. Suspendisse accumsan commodo enim, ac aliquet nunc pulvinar acorem ipsum dolor sit amet, consectetur adipiscing elit.</p>

                                <h6>¿Etiam aliquam orci sem?</h6>
                                <p>Sed dignissim sem feugiat sed. Suspendisse accumsan commodo enim, ac aliquet nunc pulvinarpsum dolor sit amet, consectetur adipiscing elit. Etiam aliquam orci sem, sed dignissim sem feugiat sed.</p>

                                <h6>¿Suspendisse accumsan commodo enim, ac aliquet nunc pulvinar?</h6>
                                <p>Psum dolor sit amet, consectetur adipiscing elit. Etiam aliquam orci sem, sed dignissim sem feugiat sed. Suspendisse accumsan commodo enim, ac aliquet nunc pulvinar</p>
                            </div>
                        </div>
                    </div>
                </div>
