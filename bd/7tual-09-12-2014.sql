...
--
-- Servidor: localhost
-- Tiempo de generación: 04-12-2014 a las 12:21:33
...
INSERT INTO `category` (`id_category`, `name_category`, `slug`, `id_category_father`, `date_created`, `date_modified`, `status`) VALUES
(1, 'Deporte', 'deporte', NULL, '2014-10-01 03:30:00', '2014-10-15 03:30:00', 1),
(2, 'Música', 'musica', NULL, '2014-10-07 03:30:00', '2014-10-15 03:30:00', 1);
...
CREATE TABLE IF NOT EXISTS `event_calendar` (
  `id_eventcalendar` int(11) NOT NULL,
...
(10, 1, 1, 'PE', 3, 'Lorem', 'lorem', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat', 'http://www.youtube.com/watch?v=8iPcqtHoR3U', ' DSDS', '0', '2014-10-15 12:44:28', '2014-11-15 12:44:28', 1, 1),
(11, 1, 2, 'PE', 2, 'Lorem ipsum dolor', 'lorem-ipsum-dolor', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat', '', 'SDSDS', '0', '2014-11-19 18:40:24', '2014-11-15 18:47:24', 1, 1),
(12, 1, 1, 'PE', 3, 'consetetur sadipscing elitr', 'consetetur-sadipscing-elitr', 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat Lorem ipsum dolor sit amet,', 'https://www.youtube.com/watch?v=9FWgcBfs5A0', 'consetetur, sadipscing, elitr', '0', '2014-10-15 01:48:17', '2014-11-15 01:48:17', 0, 1),
(14, 1, 2, 'PE', 3, 'seven tual inaguracion 1', 'seven-tual-inaguracion-1', 'El grupo vocal “Siempre Así” nace en Sevilla en la primavera de 1991. ', 'https://www.youtube.com/watch?v=9FWgcBfs5A0', 'seven, tual, 7tual', '0', '2014-11-21 11:10:53', '2014-11-21 11:10:53', 0, 1),
(15, 1, 2, 'PE', 3, 'seven tual inaguracion 2', 'seven-tual-inaguracion-2', 'El grupo vocal “Siempre Así” nace en Sevilla en la primavera de 1991. ', '', 'seven, tual, 7tual', '0', '2014-11-21 11:10:53', '2014-11-21 11:10:53', 0, 1),
(16, 1, 2, 'PE', 3, 'seven tual inaguracion 3', 'seven-tual-inaguracion-3', 'El grupo vocal “Siempre Así” nace en Sevilla en la primavera de 1991. ', 'https://www.youtube.com/watch?v=9FWgcBfs5A0', 'seven, tual, 7tual', '0', '2014-11-21 11:10:53', '2014-11-21 11:10:53', 0, 1),
(17, 1, 2, 'PE', 3, 'seven tual inaguracion 4', 'seven-tual-inaguracion-4', 'El grupo vocal “Siempre Así” nace en Sevilla en la primavera de 1991. ', '', 'seven, tual, 7tual', '0', '2014-11-21 11:10:53', '2014-11-21 11:10:53', 0, 1),
(18, 1, 2, 'PE', 3, 'seven tual inaguracion 5', 'seven-tual-inaguracion-5', 'El grupo vocal “Siempre Así” nace en Sevilla en la primavera de 1991. ', 'https://www.youtube.com/watch?v=9FWgcBfs5A0', 'seven, tual, 7tual', '0', '2014-11-21 11:10:53', '2014-11-21 11:10:53', 0, 1),
(29, 1, 1, 'PE', 1, 'prueba relation 7tual', 'seven-tual-inaguracion-6', 'prueba relation 7tual prueba relation 7tual prueba relation 7tualprueba relation 7tual prueba relation 7tual', '', '7tual, relation, prueba', '0', '2014-11-21 09:02:45', '2014-11-21 09:02:45', 0, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `relation_calendar_country`
--

CREATE TABLE IF NOT EXISTS `relation_calendar_country` (
...
--
-- Estructura de tabla para la tabla `relation_slider_country`
--

CREATE TABLE IF NOT EXISTS `relation_slider_country` (
`id_relation` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `relation_slider_country`
--

INSERT INTO `relation_slider_country` (`id_relation`, `id_slider`, `code_country`) VALUES
(2, 8, 'PE'),
(14, 18, 'PE'),
(20, 21, 'PE'),
(21, 8, 'ES'),
...
INSERT INTO `slider` (`id_slider`, `title`, `image_background`, `imagen`, `id_video`, `date_created`, `date_modified`, `status`) VALUES
(8, 'En <b>7tual</b>, trabajamos con empresas de tu ciudad para descubrir y organizar los eventos más solicitados.', 'slider-bg1.jpg', NULL, 'jUe8uoKdHao', '2014-11-27 11:41:04', '2014-11-27 11:41:04', 1),
(18, 'En 7tual, trabajamos con empresas de tu ciudad para descubrir y organizar los eventos más solicitados.', 'slider-bg22.jpg', NULL, '8MaApitQgdY', '2014-11-28 03:27:16', '2014-11-28 03:27:16', 1),
(21, '<b>7tual</b> te trae grandes eventos', 'slider-bg3.jpg', NULL, '', '2014-11-28 03:34:19', '2014-11-28 03:34:19', 0),
(22, 'En 7tual trabajamos solo para ustedes', 'slider-bg24.jpg', NULL, 'K8q5boZdKuU', '2014-11-30 01:23:22', '2014-11-30 01:23:22', 0);
...
ALTER TABLE `event_calendar`
 ADD PRIMARY KEY (`id_eventcalendar`);
...
--
-- Indices de la tabla `relation_calendar_country`
--
ALTER TABLE `relation_calendar_country`
...
--
-- Indices de la tabla `relation_slider_country`
--
ALTER TABLE `relation_slider_country`
 ADD PRIMARY KEY (`id_relation`);
...
--
-- AUTO_INCREMENT de la tabla `relation_calendar_country`
--
ALTER TABLE `relation_calendar_country`
...
--
ALTER TABLE `relation_lincc`
MODIFY `id_relation` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de la tabla `relation_slider_country`
--
ALTER TABLE `relation_slider_country`
...
--
ALTER TABLE `slider`
MODIFY `id_slider` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=23;
--
