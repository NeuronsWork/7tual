                        <!-- modal -->
                        <div class="modal fade" id="new_medic_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form class="form-horizontal" role="form" id="form_edit_medic" data-async data-target="" action="" method="POST">
                                        ...
                                        <div class="modal-body">
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control input-sm" name="inputPaterno" id="inputPaterno" placeholder="Apellido Paterno" required="true" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputMaterno" class="col-lg-3 control-label">Ape. Materno</label>
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control input-sm" name="inputMaterno" id="inputMaterno" placeholder="Apellido Materno" required="true" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputNombres" class="col-lg-3 control-label">Nombres</label>
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control input-sm" name="inputNombres" id="inputNombres" placeholder="Nombres" required="true" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="inputCategorias" class="col-lg-3 control-label">Categorías</label>
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control input-sm" name="inputCategorias" id="inputCategorias" placeholder="Categorías" required="true" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <select class="form-control input-sm" name="inputEspecializacion" id="inputEspecializacion" >
                                                    ...
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control input-sm" name="inputTitulo" id="inputTitulo" placeholder="Título" required="true" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-lg-6">
                                                        <label for="inputTelefono" class="col-lg-6 control-label">Teléfono</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control input-sm" name="inputTelefono" id="inputTelefono" placeholder="Teléfono" required="true" >
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-send"><i class="icon_plus"></i> Crear médico</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
